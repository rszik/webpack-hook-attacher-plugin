...
export class OperationParameter implements IOperationParameter {
    ...
    public javascriptParserHookForParameter?: string = null;
}
...
export abstract class Operation  {
    ...
    public compilerHookParameters: CompilerHookParameters = new CompilerHookParameters();
    public compilationHookParameters: CompilationHookParameters = new CompilationHookParameters();
    public javascriptParserHookParameters: JavascriptParserHookParameters = new JavascriptParserHookParameters();
