...
export declare class CompilationHookParameters {
    static MODULE: string;
    static ERROR: string;
    static MODULES: string;
    static CHUNKS: string;
    static CHUNK_GROUPS: string;
    ...
    chunkGroups: compilation.ChunkGroup[];
    records: compilation.Record[];
    compilation: compilation.Compilation;
    assets: compilation.Asset[];
    chunk: compilation.Chunk;
    chunkHash: compilation.ChunkHash;
    fileName: string;
    path: string;
    options: any;
    childCompiler: compiler.Compiler;
    compilerName: string;
